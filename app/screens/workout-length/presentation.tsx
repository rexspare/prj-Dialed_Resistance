...
import { Alert, Animated, BackHandler, Image, ImageBackground, Modal, Pressable, TouchableOpacity, View, ViewStyle } from "react-native"
...
export const Presentation = ({
  ...
  const handleContinue = () => {
    if (step == 2) {
      onPressButton(selectedDuration)
    } else {
      setStep(2)
    }
  }
          ...
          <View style={{ flex: 1, paddingBottom: 20, paddingHorizontal: 10 }}>
            <ImageBackground imageStyle={{ alignSelf: "center", resizeMode: "contain", left: "17.5%", width: "65%" }} style={{ width: "100%", flex: 1 }} source={require("../../../assets/bgLogo.png")}>
              <Animated.View style={{ justifyContent: 'space-between', alignItems: "center", flex: 1 }}>
                ...
                <View style={{
                ...
                }}>
                  {
                    step == 1 ?
                      ...
                      :
                      <Text style={{ marginTop: 47, textAlign: "center", fontSize: 20, textTransform: "capitalize" }}>
                ...
                <Button text='Continue' preset='primary' onPress={() => { handleContinue() }}
                  style={{
                    width: "100%",
                    alignSelf: "center",
